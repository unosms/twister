...
Route::middleware(['auth.session', 'audit.log'])->group(function () {
    ...
    Route::get('/portal/telegram-settings', fn () => redirect()->route('portal.index'))->name('portal.telegram-settings');
...
Route::middleware(['admin.auth', 'audit.log'])->group(function () {
    ...
    Route::post('/settings/scripts/import', [SettingsController::class, 'importScriptsBackup'])->name('settings.scripts.import');
