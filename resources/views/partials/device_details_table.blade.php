...
$rowStart = isset($rowStart) && is_numeric($rowStart) ? max(1, (int) $rowStart) : 1;
@endphp
...
@include('partials.device_details_row', ['device' => $device, 'credentialMode' => $credentialMode, 'rowNumber' => $rowStart + $loop->index])
@empty
<tr>
