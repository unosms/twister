...
<div class="flex flex-col gap-2"><label class="text-sm font-semibold text-gray-600 dark:text-gray-300">OLT Type *</label><select class="rounded-lg border-[#cfd7e7] dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:border-primary focus:ring-primary h-11" name="olt_device_type" data-olt-required disabled><option value="HUAWEI" selected>Huawei</option><option value="VSOL">VSOL</option><option value="HIOSO">Hioso</option></select></div>
...
<div class="flex flex-col gap-2"><label class="text-sm font-semibold text-gray-600 dark:text-gray-300">Folder Location</label><input class="rounded-lg border-[#cfd7e7] dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:border-primary focus:ring-primary h-11" name="olt_folder_location" placeholder="e.g., uno/OLT-01" type="text" disabled/></div>
</div>
</div>
